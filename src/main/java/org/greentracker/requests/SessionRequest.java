...
public class SessionRequest {
    ...
    static public String UserSubscription(String[] userInfo) throws Exception {
    ...
    static public String SessionConnection(String email, String password) throws Exception {
    ...
    static public void SessionDisconnection(Session session) throws Exception {
